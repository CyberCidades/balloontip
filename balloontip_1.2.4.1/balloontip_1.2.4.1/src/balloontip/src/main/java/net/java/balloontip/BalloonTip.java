...
//	private static Icon defaultCloseIcon  = new ImageIcon(BalloonTip.class.getResource("/net/java/balloontip/images/ic_close_15_15.png"));
//	private static Icon rolloverCloseIcon = new ImageIcon(BalloonTip.class.getResource("/net/java/balloontip/images/ic_close_15_15.png"));
//	private static Icon pressedCloseIcon  = new ImageIcon(BalloonTip.class.getResource("/net/java/balloontip/images/ic_close_15_15.png"));
	...
	public BalloonTip(JComponent attachedComponent, JLabel text) {
            this(attachedComponent, text, new RoundedBalloonStyle(5, 5, new Color(251,111,102), Color.BLACK), false);
	}
...
//	 */
//	public BalloonTip(JComponent attachedComponent, JLabel label, BalloonTipStyle style, boolean useCloseButton) {
//		this(attachedComponent, label, style, useCloseButton);
//	}
...
//	}
	...
	public void refreshLocation() {
		if (topLevelContainer!=null) {
                    System.out.println("loc: "+topLevelContainer);
